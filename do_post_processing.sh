...
python combine_grades_into_table.py tables/no_abstain_normed_logits.tex $thresholds1 True results/*no_abstain.txt results/*no_abstain_normed_logits.txt
python plot_data.py figs/no_abstain_normed_logits True 0-1 results/*no_abstain.txt results/*no_abstain_normed_logits.txt
