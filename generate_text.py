...
def set_params():
    ...
    return (model_name, prompts, args.max_new_tokens, args.num_top_tokens, args.chat_mode)
...
def generate(model_name, prompts, max_new_tokens, num_top_tokens, chat_mode):
    ...
    output = model.generate(**model_inputs, max_new_tokens=max_new_tokens, do_sample=do_sample, output_scores=True, num_return_sequences=num_return_sequences, return_dict_in_generate=True, renormalize_logits=True)
